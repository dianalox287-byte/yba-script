...
local Config = {
    ...
    ServiceId       = 32938, -- Your PlatoBoost Service ID
    PlatoSecret     = "58112c67-d9cf-4fe0-92f0-9c055cf1981f", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "OVERDRIVE-X-098poiklujuqa123", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/dianalox287-byte/yba-script/refs/heads/main/script.lua", -- The raw URL of your main script
    
    -- [4] Social Media Settings (Set to true to show, false to hide)
    ShowDiscord     = true,
    DiscordURL      = "https://discord.gg/YpyMkgdFx",
    ...
    -- [6] GUI Management
    OldGuiName      = "OVERDRIVE X", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "OVERDRIVE X", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "OVERDRIVE X", -- The main title shown at the top of the GUI
    HubDescription  = "OVERDRIVE X is a hub for Your bizzare adventure" -- The text shown below the title
}
